...
void line(int sdvgx, int sdvgy, int sizex, char x_y, char color);
void cursr(int x, int y, char color);

void cursr(int x, int y, char color)
{
        for(int i = 0; i < 7; i++)
        {
		draw_pix(x*8, y*8+i, color);
        }
}
...
void line(int sdvgx, int sdvgy, int size, char x_y, char color)
{
